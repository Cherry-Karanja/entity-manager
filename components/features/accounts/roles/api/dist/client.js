...
exports.userRoleActions = exports.userRolesApiClient = void 0;
 ...
 * ```
 */
exports.userRolesApiClient = entityManager_1.createHttpClient({
    ...
    getUsers: function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.userRolesApiClient.customAction(id, 'users')];
            });
        });
    }
};
