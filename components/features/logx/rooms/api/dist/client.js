...
var roomApiActions = {
    ...
    checkAvailability: function (id, date) { return __awaiter(void 0, void 0, Promise, function () {
        var resp, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, client_1.authApi.post("/api/v1/logx/resources/rooms/" + id + "/check_availability/", { date: date })];
                case 1:
                    resp = _a.sent();
...
exports["default"] = exports.roomsClient;
