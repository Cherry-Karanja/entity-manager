...
function useSchedules(timetableId) {
    var _this = this;
    var _a = react_1.useState([]), schedules = _a[0], setSchedules = _a[1];
    var reqRef = react_1.useRef(0);
    react_1.useEffect(function () {
        var mounted = true;
        var reqId = reqRef.current + 1;
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        console.warn('useSchedules fetch failed', err_1);
                        return [3 /*break*/, 3];
    ...
    return { schedules: schedules, setSchedules: setSchedules };
}
exports["default"] = useSchedules;
