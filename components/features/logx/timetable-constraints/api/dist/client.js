...
exports.timetableConstraintApi = __assign(__assign({}, base), { 
    ...
    validateParameters: function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_1.authApi.post("" + BASE_PATH + id + "/validate_parameters/")];
                    case 1:
                        response = _a.sent();
    ...
    checkViolations: function (id, scheduleId) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_1.authApi.post("" + BASE_PATH + id + "/check_violations/", { schedule_id: scheduleId })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
...
exports["default"] = exports.timetableConstraintApi;
