...
exports.penaltyRuleApi = __assign(__assign({}, base), { 
    ...
    calculatePenalty: function (id, timetableId, violations) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_1.authApi.post("" + BASE_PATH + id + "/calculate_penalty/", {
...
exports["default"] = exports.penaltyRuleApi;
