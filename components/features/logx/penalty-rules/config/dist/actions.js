...
exports.penaltyRuleActionsConfig = void 0;
var lucide_react_1 = require("lucide-react");
exports.penaltyRuleActionsConfig = {
    actions: [
        {
            id: "view",
            label: "View Details",
        ...
        },
        {
            ...
            confirmMessage: function (item) {
                return "Are you sure you want to " + ((item === null || item === void 0 ? void 0 : item.is_active) ? "deactivate" : "activate") + " this rule?";
            },
        ...
        },
        {
            ...
            icon: React.createElement(lucide_react_1.Calculator, { className: "h-4 w-4" }),
            actionType: "custom",
            position: "row",
...
exports["default"] = exports.penaltyRuleActionsConfig;
