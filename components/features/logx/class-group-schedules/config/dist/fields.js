            ...
            fetchOptions: function (search) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            params = search ? { params: { search: search } } : undefined;
                            return [4 /*yield*/, client_1.authApi.get('/api/v1/institution/class-groups/', params)];
                        case 1:
                            resp = _c.sent();
                            data = resp.data;
                            return [2 /*return*/, Array.isArray(data) ? data : (_b = (_a = data.results) !== null && _a !== void 0 ? _a : data.data) !== null && _b !== void 0 ? _b : []];
            ...
            fetchOptions: function (search) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            params = search ? { params: { search: search } } : undefined;
                            return [4 /*yield*/, client_1.authApi.get('/api/v1/academics/units/', params)];
                        case 1:
                            resp = _c.sent();
                            data = resp.data;
                            return [2 /*return*/, Array.isArray(data) ? data : (_b = (_a = data.results) !== null && _a !== void 0 ? _a : data.data) !== null && _b !== void 0 ? _b : []];
            ...
            fetchOptions: function (search) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            params = search ? { params: { search: search } } : undefined;
                            return [4 /*yield*/, client_1.authApi.get('/api/v1/accounts/staff/', params)];
                        case 1:
                            resp = _c.sent();
                            data = resp.data;
                            return [2 /*return*/, Array.isArray(data) ? data : (_b = (_a = data.results) !== null && _a !== void 0 ? _a : data.data) !== null && _b !== void 0 ? _b : []];
            ...
            fetchOptions: function (search) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            params = search ? { params: { search: search } } : undefined;
                            return [4 /*yield*/, client_1.authApi.get('/api/v1/logx/resources/rooms/', params)];
                        case 1:
                            resp = _c.sent();
                            data = resp.data;
                            return [2 /*return*/, Array.isArray(data) ? data : (_b = (_a = data.results) !== null && _a !== void 0 ? _a : data.data) !== null && _b !== void 0 ? _b : []];
