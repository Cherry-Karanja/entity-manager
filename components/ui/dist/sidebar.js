...
var Sidebar = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", { ref: ref, className: "group peer hidden text-sidebar-foreground md:block overflow-x-hidden", "data-state": state, "data-collapsible": state === "collapsed" ? collapsible : "", "data-variant": variant, "data-side": side },
        React.createElement("div", { className: utils_1.cn("relative w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear", "group-data-[collapsible=offcanvas]:w-0", "group-data-[side=right]:rotate-180", variant === "floating" || variant === "inset"
                ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
                : "group-data-[collapsible=icon]:w-[--sidebar-width-icon]") }),
        React.createElement("div", __assign({ className: utils_1.cn("fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex", side === "left"
