            ...
            react_1["default"].createElement(sidebar_1.SidebarInset, null,
                react_1["default"].createElement("header", { className: "sticky top-0 z-40 border-b border-sidebar-border bg-sidebar/95 backdrop-blur supports-[backdrop-filter]:bg-sidebar/60" },
                    react_1["default"].createElement("div", { className: "flex h-14 items-center gap-4 px-4" },
                        ...
                        breadcrumbs.length > 0 && (react_1["default"].createElement("nav", { className: "flex items-center space-x-2 text-sm text-sidebar-foreground/70 max-w-[48%] overflow-hidden" }, breadcrumbs.map(function (breadcrumb, index) { return (react_1["default"].createElement(react_1["default"].Fragment, { key: index },
                            index > 0 && react_1["default"].createElement("span", { className: "flex-shrink-0" }, "/"),
                            breadcrumb.href ? (react_1["default"].createElement(link_1["default"], { href: breadcrumb.href, className: "hover:text-sidebar-foreground transition-colors max-w-[12rem] truncate block" }, breadcrumb.label)) : (react_1["default"].createElement("span", { className: "text-sidebar-foreground font-medium max-w-[12rem] truncate block" }, breadcrumb.label)))); }))),
                ...
                react_1["default"].createElement("main", { className: utils_1.cn("flex-1 overflow-auto p-3", className) }, children))),
